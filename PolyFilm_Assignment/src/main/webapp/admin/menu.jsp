...
<div class="admin-sidebar">
    ...
    <nav class="sidebar-menu">
        <div class="menu-section">
            ...
            <ul>
                <li>
                    <a href="/admin/home" class="${pageContext.request.requestURI.contains('/home') ? 'active' : ''}">
                        <i class="fa-solid fa-house"></i>
                        <span>Dashboard</span>
                    </a>
                </li>
                <li>
                    <a href="/admin/videos" class="${pageContext.request.requestURI.contains('/videos') ? 'active' : ''}">
                        <i class="fa-solid fa-film"></i>
                        <span>Videos</span>
                    </a>
                </li>
                <li>
                    <a href="/admin/users" class="${pageContext.request.requestURI.contains('/users') ? 'active' : ''}">
